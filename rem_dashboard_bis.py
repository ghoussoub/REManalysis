...
def size_range(x):
    if x >= 500:
        ...
        range = "btw 400 to 500"
    elif x < 400 and x >= 300:
        range = "btw 300 to 400"
    elif x < 300 and x >= 200:
        range = "btw 200 to 300"
...
option = st.sidebar.selectbox("Select Dashboard?", ('Comparative Areas Performance','Flats Prices Trend', 'Flats Transactions Search','Villas Area Performance','Villas Prices Trend','Lands Area Performance','Lands Prices Trend','Flat Price Estimation'))
...
if option == 'Comparative Areas Performance': 
    st.header(option)
...
if  option == 'Villas Area Performance':
    st.header(option)
...
if  option == 'Villas Prices Trend':
    ...
    single_area_qtr_median_prices_df = single_area_qtr_median_prices.reset_index()
    #single_area_median_prices_df['rolling_mean'] = single_area_median_prices_df.set_index('fst_day').groupby('Room_En', sort=False)['single_area_median_price'].rolling(6).mean().round(2).to_numpy()
    single_area_median_prices_df['rolling_mean'] = single_area_median_prices_df.set_index('fst_day')['single_area_median_price'].rolling(6).mean().round(2).to_numpy()
    ...
    base5 = alt.Chart(single_area_qtr_median_prices_df).properties(height=300)
    line5 = base5.mark_line(size=2).encode(x=alt.X('fst_qtr', title='Date'),y=alt.Y('single_area_qtr_median_price', title='median price'),color=alt.Color('registry', title='registry',legend=alt.Legend(orient='right')))
    st.altair_chart(line5,use_container_width=True)
    base7 = alt.Chart(single_area_qtr_median_prices_df).properties(height=300)
    line7 = base7.mark_line(size=2).encode(x=alt.X('fst_qtr', title='Date'),y=alt.Y('single_area_qtr_median_meter_price', title='meter_median price'),color=alt.Color('registry', title='registry',legend=alt.Legend(orient='right')))
    st.altair_chart(line7,use_container_width=True)
    base6 = alt.Chart(single_area_qtr_median_prices_df).properties(height=300)
    line6 = base6.mark_line(size=2).encode(x=alt.X('fst_qtr', title='Date'),y=alt.Y('single_area_txs_count', title='txs count'),color=alt.Color('registry', title='registry',legend=alt.Legend(orient='right')))
    st.altair_chart(line6,use_container_width=True)
    st.subheader("Monthly Moving Averages Graphs (median price, median meter price & txs count)")
    base3 = alt.Chart(single_area_median_prices_df).properties(height=300)
    line3 = base3.mark_line(size=2).encode(x=alt.X('fst_day', title='Date'),y=alt.Y('rolling_mean', title='rolling median price'),color=alt.Color('registry', title='registry',legend=alt.Legend(orient='right')))
    st.altair_chart(line3,use_container_width=True)
    #with col2:
    base4 = alt.Chart(single_area_median_prices_df).properties(height=300)
    line4 = base4.mark_line(size=2).encode(x=alt.X('fst_day', title='Date'),y=alt.Y('meter_rolling_mean', title='meter rolling median price'),color=alt.Color('registry', title='registry',legend=alt.Legend(orient='right')))
    st.altair_chart(line4,use_container_width=True)
    base8 = alt.Chart(single_area_median_prices_df).properties(height=300)
    line8 = base8.mark_line(size=2).encode(x=alt.X('fst_day', title='Date'),y=alt.Y('txs_count_rolling_mean', title='monthly txs count ma'),color=alt.Color('registry', title='registry',legend=alt.Legend(orient='right')))
    st.altair_chart(line8,use_container_width=True)
    #flat_sales_select = flat_sales[(flat_sales['reg_type_en']==registry)]
if  option == 'Lands Area Performance':
...
if  option == 'Lands Prices Trend':
    ...
    base5 = alt.Chart(single_area_qtr_median_prices_df).properties(height=300)
    line5 = base5.mark_line(size=2).encode(x=alt.X('fst_qtr', title='Date'),y=alt.Y('single_area_qtr_median_price', title='median price'),color=alt.Color('land_usage', title='Usage',legend=alt.Legend(orient='right')))
    st.altair_chart(line5,use_container_width=True)
    base7 = alt.Chart(single_area_qtr_median_prices_df).properties(height=300)
    line7 = base7.mark_line(size=2).encode(x=alt.X('fst_qtr', title='Date'),y=alt.Y('single_area_qtr_median_meter_price', title='meter_median price'),color=alt.Color('land_usage', title='Usage',legend=alt.Legend(orient='right')))
    st.altair_chart(line7,use_container_width=True)
    base6 = alt.Chart(single_area_qtr_median_prices_df).properties(height=300)
    line6 = base6.mark_line(size=2).encode(x=alt.X('fst_qtr', title='Date'),y=alt.Y('single_area_txs_count', title='txs count'),color=alt.Color('land_usage', title='Usage',legend=alt.Legend(orient='right')))
    st.altair_chart(line6,use_container_width=True)
    st.subheader("Monthly Moving Averages Graphs (median price, median meter price & txs count)")
    base3 = alt.Chart(single_area_median_prices_df).properties(height=300)
    line3 = base3.mark_line(size=2).encode(x=alt.X('fst_day', title='Date'),y=alt.Y('rolling_mean', title='rolling median price'),color=alt.Color('land_usage', title='Usage',legend=alt.Legend(orient='right')))
    st.altair_chart(line3,use_container_width=True)
    #with col2:
    base4 = alt.Chart(single_area_median_prices_df).properties(height=300)
    line4 = base4.mark_line(size=2).encode(x=alt.X('fst_day', title='Date'),y=alt.Y('meter_rolling_mean', title='meter rolling median price'),color=alt.Color('land_usage', title='Usage',legend=alt.Legend(orient='right')))
    st.altair_chart(line4,use_container_width=True)
    base8 = alt.Chart(single_area_median_prices_df).properties(height=300)
    line8 = base8.mark_line(size=2).encode(x=alt.X('fst_day', title='Date'),y=alt.Y('txs_count_rolling_mean', title='monthly txs count ma'),color=alt.Color('land_usage', title='Usage',legend=alt.Legend(orient='right')))
    st.altair_chart(line8,use_container_width=True)